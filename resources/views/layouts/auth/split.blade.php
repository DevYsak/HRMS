    ...
    <div class="grid min-h-screen lg:grid-cols-2">
        ...
        <div class="relative hidden lg:flex flex-col bg-[#0f1923]">
            ...
            <div class="absolute inset-0">
                <img src="https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=1200&q=80&auto=format&fit=crop"
                    alt="Office collaboration" class="h-full w-full object-cover opacity-60" />
