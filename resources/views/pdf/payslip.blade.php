...
<head>
    ...
    <style>
        ...
        .header { margin-bottom: 30px; border-bottom: 2px solid #1DB77A; padding-bottom: 10px; }
        .header h1 { margin: 0; color: #1DB77A; font-size: 24px; }
        .header p { margin: 5px 0; color: #666; }
        .company-logo { font-size: 24px; font-weight: bold; color: #1DB77A; float: right; }
...
<body>
    <div class="header">
        <div class="company-logo">Pulse HRMS</div>
        <h1>Payslip</h1>
    ...
    <div style="margin-top: 30px;">
        <table style="width: 50%; float: right;">
            <tr class="total-row">
                ...
                <td class="text-right" style="color: #1DB77A; font-size: 16px;">₹ {{ number_format($payslip->net_salary, 2) }}</td>
            </tr>
        </table>
