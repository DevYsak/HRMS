<x-layouts::auth.split :title="__('Log in')">
    <div class="flex flex-col gap-7">
        ...
        <div class="relative">
            ...
            <div class="relative flex justify-center text-xs text-zinc-400 bg-white px-2">
                Or login with
            </div>
        </div>

        <div class="grid grid-cols-2 gap-3">
            <button type="button" class="flex items-center justify-center gap-2 rounded-lg border border-zinc-300 bg-white px-4 py-2.5 text-sm font-medium text-zinc-700 hover:bg-zinc-50 transition-colors">
                {{-- Google icon --}}
            ...
            <button type="button" class="flex items-center justify-center gap-2 rounded-lg border border-zinc-300 bg-white px-4 py-2.5 text-sm font-medium text-zinc-700 hover:bg-zinc-50 transition-colors">
                {{-- Apple icon --}}
                <svg class="size-4 fill-zinc-900" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
