    ...
    <div class="pulse-hero">
        ...
        <div class="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <button wire:click="openModal"
                class="inline-flex items-center gap-2 px-5 py-2.5 bg-brand-600 hover:bg-brand-700 border border-blue-400/50 text-white rounded-xl text-sm font-bold transition shadow-lg shadow-blue-900/30">
