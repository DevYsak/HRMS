<flux:main class="bg-zinc-50 p-6 space-y-6 dark:bg-zinc-950">
    <div class="pulse-page-header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="pulse-page-subtitle">{{ $employee->jobTitle?->name ?? 'No designation' }} â€¢ Joined {{ $employee->joining_date?->format('M d, Y') ?? 'â€”' }}</p>
            </div>
        </div>
    ...
    @if($showAddModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4"
            ...
            <div class="absolute inset-0 bg-black/40 backdrop-blur-sm" wire:click="$set('showAddModal', false)"></div>
        ...
        <div class="space-y-6">
            ...
            <form wire:submit="addTask" class="space-y-4">
                ...
                <div class="flex justify-end gap-3 pt-4">
                    <button type="button" wire:click="$set('showAddModal\', false)" class="px-4 py-2 text-sm font-semibold text-zinc-600 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-600 rounded-xl hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-colors">Cancel</button>
