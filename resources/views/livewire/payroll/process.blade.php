        ...
        <div class="pulse-card overflow-hidden">
            <div class="flex justify-between items-center mb-6">
                ...
                @if($currentPayroll->status === 'draft')
                    <flux:button wire:click="finalize" icon="paper-airplane" class="bg-amber-500 hover:bg-amber-600 text-white border-amber-500">Submit for Finance Approval</flux:button>
                @endif
