...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    private const CATALOGUE = [
        ...
        'Leave Management' => [
            ...
            ['key' => 'view_leave_carry_forward', 'label' => 'View Leave Carry Forward', 'description' => 'View carry-forward calculations and history'],
            ['key' => 'manage_leave_carry_forward', 'label' => 'Manage Leave Carry Forward', 'description' => 'Apply and reverse carry forward between leave years'],
            ['key' => 'view_leave_regularisation', 'label' => 'View Leave Regularisation', 'description' => 'View leave regularisation requests'],
            ['key' => 'create_leave_regularisation', 'label' => 'Create Leave Regularisation', 'description' => 'Raise a regularisation for a past absence'],
            ['key' => 'approve_leave_regularisation', 'label' => 'Approve Leave Regularisation', 'description' => 'Approve or reject leave regularisation requests'],
            ['key' => 'manage_leave_regularisation', 'label' => 'Manage Leave Regularisation', 'description' => 'Configure and administer leave regularisation'],
        ],
        'Payroll' => [
